            ...
            <div class="col-12 col-md-3 col-lg-3">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="row">
                        <h5 class="side-title">Registered Subjects<a href="" class="pull-right"><i class="fa fa-refresh" aria-hidden="true"></i></a></h5>
                ...
                <div class="card-body">
                    <?php
                        ...
                        <?php if(isset($errors)){
                            ...
                            <div class="alert alert-success"><span class=""></span> Your Information Has Been Updated Successfully </div>
                        <?php } }
                    ?>
                    <div class="row">
                        <div class="col-6">
                            <button type="button" class="btn  btn-outline-primary btn-sm" data-title="Edit" data-toggle="modal" data-target="#editInfo" >Edit Registration Details <span class="fa fa-edit"></span></button>
                        </div>
                    </div><br>
                    <div class="row" style="background-color:#5cb85c; padding:8px; color:#fff; border-radius:10px;">
                        <marquee behaviour="scroll" scrollamount="4"><h4>Kindly Click on Start button at the left hand side of the screen to write the subjects you have for the day</h4></marquee>
                    </div>
                    ...
                    <div class="alert alert-danger"><span class=""></span> 
                        You Can not Print Your Registration Slip, Pls Update Your Missing Informations or Subjects To Enable Slip Print Out
                    </div>
                    <?php } else {  ?>
                    <div class="text-center">
                        <a class="btn btn-success" href="slip.php?reg_no=<?php echo $reg_no ?>">Print Registration Slip</a>
                    </div>
                    <?php } ?>
                </div>
                </div>
            ...
            <div class="col-12 col-md-3 col-lg-3">
                ...
                <div class="card-body">
                    <ul class="list-styled">
                        ...
                        <li class="list-item"><button class="btn btn-warning"><span class="fa fa-arrow-right"></span></button> Next Question</li><br>
                        <li class="list-item"><button class="btn btn-warning"><span class="fa fa-arrow-left"></span></button> Previous Question</li><br>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label>Reg No</label>
                                            <input class="form-control " name="reg_no" value="<?php echo $reg_no ?>" type="text" placeholder="Pls Enter Your First Name">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Class</label>
                                            <input class="form-control " name="class" value="<?php echo $class ?>"  type="class" placeholder="Pls Enter Your class">
                                        </div>
                                    </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class=" col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label class="row col-sm-7 control-label" for="textinput">Passport : <span class="text-danger">*</span></label>
                                                <div class="row col-sm-6">
                                                    <div class="panel panel-default">
                                                        <div class="panel-body">
                                                            <img class="img-responsive" src="images/images.jpg">
                                                            <input type="file" name="passport" id="passport" value="<?php if(isset($_POST['register'])){ echo $_POST['passport'];}  ?>"  class="form-control" placeholder="Passport" tabindex="1" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
